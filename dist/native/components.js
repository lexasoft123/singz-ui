...
export function ReferenceControls(props) {
    ...
    return (_jsxs(GlassSurface, { radius: 25, accessibilityRole: "adjustable", accessibilityLabel: L.volume, accessibilityValue: { min: minPercent, max: maxPercent, now: props.volumePercent, text: L.volumeValue(props.volumePercent) }, style: s.referencePanel, children: [_jsxs(View, { style: s.referenceHeader, children: [_jsxs(View, { children: [_jsx(Text, { style: [s.utilityLabel, { color: theme.dim }], children: L.title.toLocaleUpperCase() }), _jsxs(Text, { style: [s.referenceValue, { color: theme.text }], children: [props.volumePercent, "%"] })] }), _jsxs(Pressable, { accessibilityRole: "button", accessibilityLabel: props.testLabel, disabled: props.testing, onPress: props.onTest, style: ({ pressed }) => [s.referenceTest, { backgroundColor: theme.accent }, (pressed || props.testing) && s.pressed], children: [props.testIcon, _jsx(Text, { style: [s.referenceTestText, { color: theme.accentInk }], children: props.testing ? L.playing : props.testLabel })] })] }), _jsxs(View, { style: s.referenceVolumeRow, children: [_jsx(RoundAction, { label: L.decrease, icon: _jsx(Text, { style: [s.referenceStepText, { color: theme.text }], children: "\u2212" }), onPress: props.onDecrease, size: 48, disabled: props.decreaseDisabled }), _jsx(View, { style: [s.referenceTrack, { backgroundColor: theme.controlLine }], children: _jsx(View, { style: [s.referenceFill, { width: `${Math.round(position * 100)}%`, backgroundColor: theme.accent }] }) }), _jsx(RoundAction, { label: L.increase, icon: _jsx(Text, { style: [s.referenceStepText, { color: theme.text }], children: "+" }), onPress: props.onIncrease, size: 48, disabled: props.increaseDisabled })] }), props.hint && _jsx(Text, { style: [s.referenceHint, { color: theme.dim }], children: props.hint }), props.pitchWindow && _jsxs(_Fragment, { children: [_jsx(Hairline, {}), _jsxs(View, { style: s.pitchWindow, children: [_jsxs(View, { children: [_jsx(Text, { style: [s.utilityLabel, { color: theme.dim }], children: L.pitchWindow.toLocaleUpperCase() }), _jsxs(Text, { style: [s.pitchWindowValue, { color: theme.text }], children: ["\u00B1", props.pitchWindow.value, "\u00A2"] })] }), _jsx(View, { style: s.choiceRow, children: props.pitchWindow.options.map((value) => _jsx(ChoiceChip, { label: `±${value}¢`, selected: props.pitchWindow?.value === value, onPress: () => props.pitchWindow?.onChange(value) }, value)) })] })] })] }));
}
...
export function PitchMeter(props) {
    ...
    return (_jsxs(View, { style: s.meterWrap, children: [_jsxs(View, { style: s.meterLabels, children: [_jsx(Text, { style: [s.meterEdge, { color: theme.dim }], children: L.flat.toLocaleUpperCase() }), _jsxs(Text, { style: [s.meterCenterLabel, { color: theme.accent }], children: ["\u00B1", props.pitchWindowCents, "\u00A2"] }), _jsx(Text, { style: [s.meterEdge, { color: theme.dim }], children: L.sharp.toLocaleUpperCase() })] }), _jsxs(GlassSurface, { radius: 30, elevation: "none", accessibilityLabel: props.accessibilityReading ?? props.reading, style: s.meter, children: [_jsx(View, { style: [s.targetZone, { left: `${50 - props.pitchWindowCents * 0.8}%`, width: `${props.pitchWindowCents * 1.6}%`, backgroundColor: theme.accentSoft }] }), _jsx(View, { style: [s.meterCenter, { backgroundColor: theme.accent }] }), props.cents !== null && _jsx(View, { style: [s.pitchMarker, { left: `${x}%`, backgroundColor: props.centered ? theme.accent : theme.text, borderColor: props.centered ? theme.text : theme.lineStrong, shadowColor: theme.accent }] })] }), _jsxs(View, { style: s.livePitchRow, children: [_jsxs(View, { children: [_jsx(Text, { style: [s.livePitchLabel, { color: theme.dim }], children: L.youAreSinging.toLocaleUpperCase() }), _jsx(Text, { accessibilityLiveRegion: "polite", style: [s.livePitchNote, { color: theme.text }], children: props.detectedNote ?? '—' })] }), _jsx(Text, { style: [s.meterReading, { color: theme.text }], children: props.reading })] }), _jsx(View, { accessibilityLabel: L.progress(props.instruction, Math.round(props.progress * 100)), style: [s.progressTrack, { backgroundColor: theme.line }], children: _jsx(View, { style: [s.progressFill, { width: `${Math.round(Math.max(0, Math.min(1, props.progress)) * 100)}%`, backgroundColor: theme.accent }] }) }), _jsx(Text, { accessibilityLiveRegion: "polite", style: [s.meterInstruction, { color: props.centered ? theme.accent : theme.dim }], children: props.instruction }), _jsx(Text, { style: [s.meterHint, { color: theme.dim }], children: props.hint })] }));
}
